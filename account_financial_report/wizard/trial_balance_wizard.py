...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    show_partner_details = fields.Boolean(string="Mostrar detalles de empresa")

    show_partner_details_add = fields.Boolean(string="Mostrar detalles de empresa con cuentas adicionales")
    ...
    def onchange_show_partner_details(self):
        ...
        if self.show_partner_details:
            ...
            self.show_partner_details_add = False #COLOCAR EN FALSE CUANTO SE DESACTIVE LA OPCION DE MOSTRAR DETALLES DE EMPRESA.
    @api.multi
    ...
    def _prepare_report_trial_balance(self):
        ...
        return {
            ...
            'show_partner_details_add': self.show_partner_details_add, #NUEVO AGREGADO CORRESPONDIENTE PARA EL RETURN
        }
